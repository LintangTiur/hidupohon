      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8">
            ...
            <button
              type="button"
              className="w-full bg-white border-2 border-gray-200 text-charcoal py-3 rounded-lg hover:bg-gray-50 transition font-medium mb-3 flex items-center justify-center space-x-2"
            >
            ...
            <button
              type="button"
              className="w-full bg-white border-2 border-gray-200 text-charcoal py-3 rounded-lg hover:bg-gray-50 transition font-medium flex items-center justify-center space-x-2"
            >
